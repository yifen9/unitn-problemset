...
cell s =
    td [ A.class "px-6 py-5 text-2xl" ] [ text s ]
        ...
        [ table [ A.class "table w-full border-2 border-base-300/60" ]
            [ thead [ A.class "bg-base-200" ]
                [ tr [ A.class "divide-x-2 divide-base-300/60" ]
                    [ th [ A.class "px-6 py-5 text-2xl font-bold" ] [ text "Name" ]
                    , th [ A.class "px-6 py-5 text-2xl font-bold" ] [ text "ID" ]
                    , th [ A.class "px-6 py-5 text-2xl font-bold" ] [ text "Size" ]
                    , th [ A.class "px-6 py-5 text-2xl font-bold" ] [ text "Coverage" ]
                    ]
                ]
            , tbody [ A.class "divide-y-2 divide-base-300/60" ]
                (List.map
                    (\c ->
                        tr [ A.class "divide-x-2 divide-base-300/60" ]
                            [ td [ A.class "px-6 py-5 text-2xl" ] [ a [ A.href ("/?subject=" ++ c.id), A.class "link" ] [ text c.name ] ]
                            , cell c.id
