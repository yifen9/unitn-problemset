...
view topCenter leftPanel content rightPanel =
    section
        ...
        , aside [ A.class "row-start-2 col-start-1 overflow-hidden border-r-2 border-base-300/60" ] [ leftPanel ]
        , main_ [ A.class "row-start-2 col-start-2 overflow-hidden border-r-2 border-base-300/60 p-0 m-0" ] [ content ]
        , aside [ A.class "row-start-2 col-start-3 overflow-hidden border-r-2 border-base-300/60" ] [ rightPanel ]
        ]
