...
view onQuery q content rightPanel =
    section
        [ A.class "grid grid-rows-[4rem,1fr] grid-cols-[2fr_8fr_2fr] h-[100dvh] bg-base-100 text-base-content"
        ...
        , aside [ A.class "row-start-2 col-start-1 overflow-y-auto border-r-2 border-base-300/60" ] [ SideMenu.view ]
